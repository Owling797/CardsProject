...
public:
    GameRules(int type = 36, int n = 2, int gm = 0, int ps = 0, int jkrs = 0, int view = 0)
    {
        deckType = type;
        gamers = n;
        givemore = gm;
...
{
public:
    Game(int t = 36, int n = 2, int gm = 0, int ps = 0, int j = 0, int v = 0) : GameRules(t, n, gm, ps, j, v) {}
